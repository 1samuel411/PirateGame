...
{
	public class PartyClientResponseHandler
    {

        private PartyClient _client;

        public PartyClientResponseHandler(PartyClient client)
        {
            _client = client;
        }
        ...
        {
            _client.networkPlayers = ByteParser.ConvertToNetworkPlayersParty(responseBytes);
        }
    }
}
