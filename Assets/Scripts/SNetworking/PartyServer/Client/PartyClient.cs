...
namespace SNetwork.Client
{
    public class PartyClient : MonoBehaviour
    {
        ...
        public PartyNetworkPlayer[] networkPlayers;
        ...
        public PartyClientSettingsScriptableObject clientSettings;
        ...
        public void SendString(string data, int sendCode = 2, int customCode = 0)
        {
            ...
            PartyMessaging.instance.SendFinal(Encoding.ASCII.GetBytes(data), 21, sendCode, ourId, customCode, clientSocket);
        }
        ...
        private PartyNetworkPlayer[] GetNetworkPlayers()
        {
