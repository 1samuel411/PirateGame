...
Shader "FAE/Tree Branch"
{
	Properties
	{
		...
		_WindWeight("WindWeight", Range( 0 , 1)) = 0.1164738
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 Wind17 = ( ( ( WindVectors99 * v.color.r ) * _WindWeight ) + appendResult283 );
			v.vertex.xyz += Wind17;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult246 = lerp( ( tex2DNode19 * _GradientBrightness ) , tex2DNode19 , i.vertexColor.a);
			...
			float4 SSS45 = ( ( ( (0.0 + (dotResult36 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * i.vertexColor.r ) * _TransmissionColor.a ) * ( _TransmissionColor * _LightColor0 ) );
...
/*ASEBEGIN
Version=13701
1927;29;1906;1004;897.7936;825.2552;1.3;True;True
...
Node;AmplifyShaderEditor.DotProductOpNode;36;-3137.692,548.1992;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1695.998,-1576;Float;False;Property;_WindWeight;WindWeight;6;0;0.1164738;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.OneMinusNode;49;-2329.393,1396.799;Float;False;1;0;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-1871.637,53.5219;Float;False;Constant;_Float3;Float 3;10;0;1;0;0;0;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-2069.393,1351.298;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;31;-1982.097,-261.8007;Float;False;Alpha;-1;True;1;0;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.SimpleAddOpNode;270;-2341.993,166.6224;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;938.3005,-293.7;Float;False;True;2;Float;FAE.TreeBranchShaderGUI;200;0;Standard;FAE/Tree Branch;False;False;False;False;False;False;False;False;True;False;False;False;True;False;False;False;True;Off;0;0;False;0;0;Custom;0.5;True;True;0;True;Opaque;AlphaTest;All;True;True;True;True;True;True;True;False;True;True;False;False;False;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;False;0;20.3;10;25;True;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;200;Nature/SpeedTree;0;-1;-1;-1;0;0;0;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=5B44B9FD7099563A4AF3C066BDEBE2778FC0FB2D